...
#check ModalThesis.IteratedVirtual.GlobularIndex.Obj
#check ModalThesis.IteratedVirtual.GlobularSetPsh
#check ModalThesis.IteratedVirtual.GlobePsh
#check ModalThesis.IteratedVirtual.kCellPsh
